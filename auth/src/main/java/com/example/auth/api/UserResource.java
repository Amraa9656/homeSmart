...
public class UserResource
{
    ...
    {
        User userData = userService.saveUser(new User(null,user.getName(), user.getUsername(), user.getPassword(), new ArrayList<>()));
        userService.addRoleToUser( userData.getUsername(), "ROLE_USER");
